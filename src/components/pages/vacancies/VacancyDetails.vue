      ...
      <div class="row g-4">
        ...
        <div class="col-lg-8">
          ...
          <div class="detail-card">
            ...
            <p class="desc-text">
              ...
              The ideal candidate will help design, develop, test, and maintain
          ...
          <div class="detail-card">
            ...
            <p class="desc-text" style="white-space:pre-line;">
              This is a full-time software development position.

              The successful candidate will work with the development team
              to build and maintain modern web applications.
            </p>
        ...
        <div class="col-lg-4">
          ...
          <div class="detail-card">
            ...
            <p class="desc-text" style="font-size:.8rem;">
              We are a company focused on building modern technology
              solutions and creating opportunities for talented professionals.
            </p>
